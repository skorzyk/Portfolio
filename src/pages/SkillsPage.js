        ...
        >
          ...
          <SwiperSlide>
            <div className="slide-wrapper">
              ...
              />
              <p className="slide-desc">
                Project with your favorite Pokemon! Just use the button and
                you'll get new pokemon. You can also use search to find your
                pokemon amongst so far downloaded.
              </p>
              <div className="img-wrapper">
                <img src={html5} alt="html" className="img-icons" />
                <img src={js} alt="js" className="img-icons" />
          ...
          <SwiperSlide>
            <div className="slide-wrapper">
              ...
              />
              <p className="slide-desc">
                Budget application. You can add your incomes and expenses, in
                case of a mistake, edit the funds already added. Are you also
                waiting for your payment day?
              </p>
              <div className="img-wrapper">
                <img src={html5} alt="html" className="img-icons" />
                <img src={js} alt="js" className="img-icons" />
          ...
          <SwiperSlide>
            <div className="slide-wrapper">
              ...
              />
              <p className="slide-desc">
                A sketchbook created thanks to the p5.js library. Of course,
                it's not as great an app as Paint, but still it does provide a
                moment of fun.
              </p>
              <div className="img-wrapper">
                <img src={html5} alt="html" className="img-icons" />
          ...
          <SwiperSlide>
            <div className="slide-wrapper">
              ...
              />
              <p className="slide-desc">
                On my github account you will find other projects that I do. I
